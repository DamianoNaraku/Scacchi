...
import cleii.scacchi2.pezzi2.*;

public class Scacchiera2 {
        private Pezzo2[] scacchiera = new Pezzo2[64];
        ...
        Scacchiera2() {
                for (int j=0; j<2; j++) {
                        ...
                        for (int i=0; i<=15; i++) {
                                switch(i) {
                                case 0: case 7: scacchiera[i+k]= new Torre2(bn); break;
                                case 1: case 6: scacchiera[i+k]= new Cavallo2(bn); break;
                                case 2: case 5: scacchiera[i+k]= new Alfiere2(bn); break;
                                case 3: scacchiera[i+k]= new Re2(bn); break;
                                case 4: scacchiera[i+k]= new Regina2(bn); break;
                                default: scacchiera[i+p]= new Pedone2(bn); break;
                                }
                        }
                }
        }

        public Pezzo2 get (int pos) {	//richiama il metodo convertitore che trasforma da notazione numerica
